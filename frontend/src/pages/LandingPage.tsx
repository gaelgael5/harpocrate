  ...
  return (
    <div className={styles.root}>
      ...
      <section
        ...
        style={{ paddingTop: 80 + bannerOffset }}
      >
      ...
      <section className={styles.terminal} id="terminal">
        ...
        <h2 className={styles.sectionTitle}>
          {t("landing.terminal.titleLine1")}
          <br />
          <span className={styles.sectionTitleAccent}>
            {t("landing.terminal.titleAccent")}
          </span>
        </h2>
        <div className={styles.terminalWindow}>
          ...
          <div className={styles.terminalBody}>
            ...
            <div className={styles.terminalOut}>
              {t("landing.terminal.installSuccess")}
            </div>
            ...
            <div className={styles.terminalOut}>
              {t("landing.terminal.unlocking")}
            </div>
            <div className={styles.terminalSuccess}>
              ✓ postgres://user:s3cr3t@db.internal/prod
            </div>
            ...
            <div className={styles.terminalSuccess}>
              {t("landing.terminal.execSuccess")}
            </div>
