      ...
      <AppShell.Navbar className={styles.navbar} style={{ top: offset + 56 }}>
        ...
        {isAdmin && (
          <>
            ...
            <NavLink
              component={RouterNavLink}
              to="/admin/backup-remotes"
              label={t("admin.nav_remote_backups")}
            />
            <NavLink
              component={RouterNavLink}
              to="/admin/backups"
            ...
            <NavLink
              component={RouterNavLink}
              to="/admin/replication"
              label={t("admin.nav_replication")}
            />
            <NavLink
              component={RouterNavLink}
