...
const THEMES: readonly ThemeDef[] = [
  ...
  },
  {
    id: "backups",
    i18nKey: "backups",
    vars: ["AGE_PUBLIC_KEY", "BACKUP_LOCAL_PATH", "BACKUP_UPLOAD_MAX_BYTES"],
  },
  {
    id: "cluster",
    i18nKey: "cluster",
...
function organizeByTheme(envEntries: ReadonlyArray<[string, string]>): {
  themed: Map<string, [string, string][]>;
...
function AgeKeyResultModal({
  ...
  return (
    <Modal
      opened
      onClose={onClose}
      title={t("admin.env.age.modalTitle")}
      size="lg"
    >
      <Stack>
