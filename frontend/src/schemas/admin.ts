...
export type SecretTypeListResponse = z.infer<
  typeof SecretTypeListResponseSchema
>;
...
export type ValidateSchemaResponse = z.infer<
  typeof ValidateSchemaResponseSchema
>;
...
export type RemoteBackupTestResponse = z.infer<
  typeof RemoteBackupTestResponseSchema
>;
...
export type RemoteBackupPushResult = z.infer<
  typeof RemoteBackupPushResultSchema
>;
...
export type ScheduledBackupListResponse = z.infer<
  typeof ScheduledBackupListResponseSchema
>;
...
export type CronValidationResponse = z.infer<
  typeof CronValidationResponseSchema
>;
...
export type ScheduledBackupRunResult = z.infer<
  typeof ScheduledBackupRunResultSchema
>;
...
export const ReplicationNodeSchema = z.object({
  ...
  last_state: z
    .enum(["streaming", "catchup", "disconnected", "unknown"])
    .nullable(),
...
export type ReplicationNodeListResponse = z.infer<
  typeof ReplicationNodeListResponseSchema
>;
...
export type ReplicationNodeAddResponse = z.infer<
  typeof ReplicationNodeAddResponseSchema
>;
...
export type ReplicationNodeObservation = z.infer<
  typeof ReplicationNodeObservationSchema
>;
...
export type ReplicationStatusResponse = z.infer<
  typeof ReplicationStatusResponseSchema
>;
